#!/bin/sh
#Torque directives
#PBS -N nI_50_nj_200_normal
#PBS -W group_list=yetistats
#PBS -l nodes=1,walltime=08:00:00,mem=8gb
#PBS -V
#PBS -t 1-500
...
R CMD BATCH --no-save --vanilla -${PBS_ARRAYID} $PBS_O_WORKDIR/nI_50_nj_200_normal.r $outdir/$PBS_JOBNAME.routput
