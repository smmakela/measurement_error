makedata_binary <- function(seed, N_lo, N_hi, J, mu, tau, gamma0, gamma1, gamma2, sigma_a, beta, sigma_y) {
...
# zfun is defined above and draws a bernoulli rv with probability given by each entry of ymean
  ymean <- alpha_j_rep + beta*z
  y <- sapply(ymean, zfun, n = 1)
