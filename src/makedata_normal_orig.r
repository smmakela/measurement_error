...
# NOTE that this version uses p_j in generating alpha_j
library(plyr)
...
# draw alpha_j ~ N(gamma0 + gamma1 * p_j + gamma2 * corr_covar, sigma^2_a)
  alphamean <- gamma0 + gamma1*p_j + gamma2*corr_covar
